...
def get_model_and_assets():
  ...
  return common.read_model('walker_distractor.xml'), common.ASSETS
...
class PlanarWalker(base.Task):
  ...
  def get_observation(self, physics):
    ...
    walker_x = physics.data.qpos[0]

    physics.named.data.qpos['dis1x'] = walker_x + np.random.uniform(-2, 2)
    physics.named.data.qpos['dis1y'] = np.random.uniform(1, 3)
    physics.named.data.qpos['dis2x'] = walker_x + np.random.uniform(-2, 2)
    physics.named.data.qpos['dis2y'] = np.random.uniform(1, 3)
